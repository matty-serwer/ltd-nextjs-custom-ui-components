        ...
        <main className="page-wrapper bg-gradient-to-br from-surface-50 via-brand-50/10 to-accent-50/20">
            ...
            <header className="mb-16">
                ...
                <p className="max-w-2xl text-lg text-surface-600">
                    Dialog components that overlay the main content. See how
                    modals handle forms, confirmations, and detailed content
                    while managing focus and backdrop behavior.
                </p>
            </header>
            ...
            <section className="showcase-section">
                ...
                <p className="mb-8 text-surface-600">
                    Different dialog patterns for various use cases:
                    information, confirmation, and form input.
                </p>
                    ...
                    <Dialog>
                        ...
                        <DialogContent className="sm:max-w-md">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Dialogs are modal windows that appear in
                            ...
                            <div className="py-4">
                                <p className="text-sm text-surface-600">
                                    They disable all app functionality when they
                                    appear, and remain on screen until
                                    confirmed, dismissed, or a required action
                                    has been taken.
                                </p>
                            </div>
                            <DialogFooter>
                    ...
                    <Dialog open={formOpen} onOpenChange={setFormOpen}>
                        ...
                        <DialogContent className="sm:max-w-lg">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Add a new member to your team. They&apos;ll
            ...
            <section className="showcase-section">
                ...
                <p className="mb-8 text-surface-600">
                    Dialogs can be sized to fit their content, from compact
                    alerts to full-width detail views.
                </p>
                ...
                <div className="flex flex-wrap gap-4">
                    ...
                    <Dialog>
                        ...
                        <DialogContent className="sm:max-w-md">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    The default size works well for most use
                                    cases.
                                </DialogDescription>
                            </DialogHeader>
                            <div className="py-4">
                                <p className="text-sm text-surface-600">
                                    This provides enough space for forms,
                                    confirmations, and moderate amounts of
                                    content without overwhelming the viewport.
                                </p>
                            </div>
                            <DialogFooter>
                                <DialogClose asChild>
                    ...
                    <Dialog>
                        ...
                        <DialogContent className="sm:max-w-2xl">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Ideal for detailed content, previews, or
                                    complex forms.
                                </DialogDescription>
                            </DialogHeader>
                            <div className="py-4">
                                ...
                                <p className="mt-4 text-sm text-surface-600">
                                    Large dialogs can contain complex layouts,
                                    tables, charts, or multi-step forms while
                    ...
                    <Dialog>
                        ...
                        <DialogContent className="max-w-xl sm:max-w-4xl">
                            <DialogHeader>
                                <DialogTitle>Full Width Dialog</DialogTitle>
                                <DialogDescription>
                                    For complex interfaces like data tables or
                                    dashboards.
                                </DialogDescription>
                            </DialogHeader>
                            <div className="py-4">
            ...
            <section className="showcase-section">
                ...
                <p className="mb-8 text-surface-600">
                    Dialogs containing complex components like cards, avatars,
                        ...
                        <DialogContent className="sm:max-w-lg">
                            ...
                            <div className="py-4">
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="text-sm text-surface-600">
                                        Design lead with 8+ years of experience
                                        creating beautiful, user-centered
                    ...
                    <Dialog>
                        ...
                        <DialogContent className="sm:max-w-2xl">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Dashboard Design - Final Version
                                </DialogDescription>
                            </DialogHeader>
                            <div className="py-4">
            ...
            <section className="showcase-section border-purple-200 bg-gradient-to-br from-purple-50/50 to-surface-50">
                ...
                <p className="mb-8 text-surface-600">
                    A realistic scenario showing how dialogs integrate with
                    other components in a workflow.
                </p>
