    ...
    <main className="page-wrapper bg-gradient-to-br from-surface-50 via-brand-50/30 to-surface-100">
      ...
      <header className="mb-16">
        ...
        <p className="max-w-2xl text-lg text-surface-600">
          Core data entry components working together. See how buttons align with inputs,
          selects integrate with form fields, and toast notifications provide feedback.
        </p>
      </header>
      ...
      <section className="showcase-section">
        ...
        <p className="mb-8 text-surface-600">
          Buttons in different states and sizes. Click any button to trigger a toast notification.
        </p>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <Button onClick={() => toast.success("Primary action triggered!")}>
                Primary
              </Button>
              ...
              <Button variant="outline" onClick={() => toast.info("Outline button")}>
                Outline
              </Button>
              <Button variant="ghost" onClick={() => toast("Ghost button")}>
                Ghost
              </Button>
              <Button variant="link" onClick={() => toast("Link style")}>
                Link
              </Button>
            </div>
          </div>
      ...
      <section className="showcase-section">
        ...
        <div className="demo-grid">
          ...
          <div>
            ...
            <Input type="file" className="cursor-pointer file:mr-4 file:rounded-md file:border-0 file:bg-brand-100 file:px-4 file:py-2 file:text-sm file:font-medium file:text-brand-700 hover:file:bg-brand-200" />
          </div>
        </div>
      </section>
      ...
      <section className="showcase-section border-brand-200 bg-gradient-to-br from-brand-50/50 to-surface-50">
        ...
        <p className="mb-8 text-surface-600">
          All form components working together with validation and toast feedback.
        </p>
      ...
      <section className="showcase-section">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <Button
            variant="outline"
            onClick={() => toast.info("Information", { description: "Here's something you should know." })}
          >
            Info Toast
          </Button>
          <Button
